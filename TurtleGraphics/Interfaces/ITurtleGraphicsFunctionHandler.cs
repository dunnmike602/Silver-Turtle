...
{
    public interface ITurtleGraphicsFunctionHandler
    {
        List<TurtleGraphicsFunctionCommand> GetFunctions();
        void ClearFunctions();
        void AddFunction(TurtleGraphicsFunctionCommand function);
        string GetAllFunctionProgramText();
        event FunctionChangedEventHandler FunctionChanged;
    }
}