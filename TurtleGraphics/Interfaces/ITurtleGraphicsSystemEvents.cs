...
{
    public interface ITurtleGraphicsCommandsEvents
    {
        event ClearedEventHandler Cleared;
        event PenStatusEventHandler PenStatusChanged;
        event ColorChangeEventHandler ColorChanged;
        event PenWidthEventHandler PenWidthChanged;
    }
}