...
{
    public class TurtleGraphicsWhileCommand : TurtleGraphicsBlockCommand
    {
        public int Lhs
        {
        ...
        /// <summary>
        /// While commands are conditionally executed.
        /// </summary>
        public override bool Execute(ICanceller canceller)
        {
            ...
            while (ExpressionComparerHelper.CheckCondition(Lhs, Operator, Rhs))
            {
                if (shouldContinue)
                {
