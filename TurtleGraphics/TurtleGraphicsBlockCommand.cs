...
{
    /// <summary>
    /// Represents a type of commands that has a nested body delimited by []
    /// </summary>
    public class TurtleGraphicsBlockCommand : TurtleGraphicsCommand
    {
        public override void ValidateCommand()
        {
            ...
            if (Commands.Count == 0)
            {
                Status = TurtleGraphicsCommandStatus.LoopHasNoCommands;
